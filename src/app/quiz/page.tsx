														...
														{[
															...
															return (
																<button
																	...
																	className={`flex items-center gap-1 sm:gap-2 py-2 sm:py-3 px-2 sm:px-4 border-b-2 font-medium text-xs sm:text-sm transition-all duration-200 flex-1 sm:flex-none min-w-0 ${
																...
																>
																	...
																	<span className="sm:hidden truncate">{tab.label.charAt(0)}</span>
																	{tab.count > 0 && (
																		<span className={`ml-1 bg-${tab.color}-500/20 text-${tab.color}-300 py-0.5 px-1 sm:px-2 rounded-full text-xs font-medium flex-shrink-0`}>
																			{tab.count}
																		</span>
																	)}
																</button>
