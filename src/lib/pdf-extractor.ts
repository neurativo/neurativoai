...
// Add minimal DOMMatrix polyfill for pdfjs to stop crashing
...
export async function extractPDFText(buffer: Buffer): Promise<PDFExtractionResult> {
  try {
    ...
    console.log('Starting PDF extraction with pdf-parse (with DOMMatrix polyfill)...');
    console.log('Buffer size:', buffer.length, 'bytes');
    
    // Use pdf-parse with polyfill
