...
export const CrownIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    className={className} 
...
export const FilePdfIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    className={className} 
  ...
  >
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 9h4v4h-4V9z" />
  </svg>
);
...
export const YoutubeIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg 
    width={size} 
    height={size} 
    className={className} 
