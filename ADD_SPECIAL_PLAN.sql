...
-- Run these SQL commands SEPARATELY in your Supabase SQL Editor

-- STEP 1: First, add 'special' to the plan_t enum type
-- Run this command FIRST and wait for it to complete
ALTER TYPE plan_t ADD VALUE IF NOT EXISTS 'special';

-- STEP 2: After the above command completes, run this command
...
-- STEP 3: Verify the plan was added
